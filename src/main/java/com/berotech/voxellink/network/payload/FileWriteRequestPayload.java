...
public record FileWriteRequestPayload(int requestId, String targetId, String path, String content) implements CustomPacketPayload {
    ...
    public static final StreamCodec<FriendlyByteBuf, FileWriteRequestPayload> STREAM_CODEC = StreamCodec.composite(
            ...
            FileWriteRequestPayload::targetId,
